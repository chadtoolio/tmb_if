...
pass_check = tkinter.Checkbutton(password_fr, text="I accept the terms and conditions.",
                                  variable=password_entry, onvalue="It Worky", offvalue="No Worky")
pass_check.grid(row=3, column=1)
